...
from myoagency.audit import audit_dataset_root, write_audit


def main() -> None:
    parser = argparse.ArgumentParser(description="Audit a downloaded open prosthetics dataset.")
    parser.add_argument("--dataset", required=True, choices=["db10", "hyser", "cemhsey", "grabmyo", "capgmyo_dba", "putemg"])
