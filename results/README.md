...
This directory contains publication-facing derived outputs only. It intentionally excludes raw data, downloaded archives, full prepared arrays, trained model binaries, and large per-episode timing dumps.

Included:

- `reports/publication_clean/`: frozen CSV/JSON/Markdown outputs used by publication tables, claim-boundary audits, and figure generation.
