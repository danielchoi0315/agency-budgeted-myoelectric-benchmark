...
- [ ] `python scripts/check_tnsre_figures.py --out-dir results/reports/tnsre_figures --recursive --min-pdfs 11 --min-width 1800 --min-height 1800 --min-dpi 300 --report results/reports/tnsre_figures/tnsre_figure_qa.json` passes.
